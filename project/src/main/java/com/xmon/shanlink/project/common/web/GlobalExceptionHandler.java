package com.xmon.shanlink.project.common.web;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.xmon.shanlink.project.common.convention.errorcode.BaseErrorCode;
import com.xmon.shanlink.project.common.convention.exception.AbstractException;
...
public class GlobalExceptionHandler {
    ...
    public Result<Void> abstractException(HttpServletRequest request, AbstractException ex) {
        ...
        if (ex.getCause() != null) {
            log.error("[{}] {} [ex] {}", request.getMethod(), url, ex, ex.getCause());
        } else {
            log.error("[{}] {} [ex] {}", request.getMethod(), url, ex.toString());
        }
